...
var app = (function () {
    ...
    /* src/Show.svelte generated by Svelte v3.21.0 */

    const file = "src/Show.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 9, 2, 50);
    			attr_dev(div, "class", "");
    			add_location(div, file, 10, 2, 64);
    			add_location(stage, file, 8, 0, 40);
    		},
